...
(1,'Beca Auxiliar',1000000,1000,999000,0.00,'activa'),
(2,'Beca Legislativa',200000,200,199900,0.00,'activa'),
(3,'Beca FSEOG',1000000,1000,1000000,3.00,'activa'),
(4,'Programa ACG',1000000,750,999700,3.50,'activa'),
...
(8,'Beca CCOM',100000,300,99800,3.00,'activa'),
(9,'Beca ADEM',100000,300,99700,3.00,'activa'),
...
(18,'CHRISTOPHER','CARRION','HERNANDEZ',7,3.40,'christopher.carrion1@upr.edu'),
(19,'GABRIEL','FERRER','TORRES',7,3.30,'gabriel.ferrer1@upr.edu'),
(20,'CARLOS','GALAN','DE ARCE',7,3.80,'carlos.galan@upr.edu'),
(21,'OMAR','GONZALEZ','BARRETO',7,4.00,'omar.gonzalez17@upr.edu'),
(22,'JONATHAN','GONZALEZ','GONZALEZ',7,3.90,'jonathan.gonzalez21@upr.edu'),
(23,'JONAS','GONZALEZ','LOPEZ',7,3.50,'jonas.gonzalez@upr.edu'),
(24,'GABRIEL','GONZALEZ','VEGA',7,3.50,'gabriel.gonzalez20@upr.edu'),
(25,'CHRISTIAN','HERNANDEZ','RUIZ',7,3.75,'christian.hernandez19@upr.edu'),
(26,'ROSA','MILANES','RUSSI',7,3.45,'rosa.milanes@upr.edu'),
(27,'ADRIAN','RODRIGUEZ','RODRIGUEZ',7,3.65,'adrian.rodriguez7@upr.edu'),
(28,'NOEL','ROJAS','RIVERA',7,3.50,'noel.rojas@upr.edu'),
(29,'BRYAN','TACORONTE','MORALES',7,3.35,'bryan.tacoronte@upr.edu'),
(30,'CHRISTIAN','TIRADO','MORALES',7,3.50,'christian.tirado2@upr.edu'),
(31,'HIRAM','VERA','MERCADO',7,3.62,'hiram.vera@upr.edu'),
(32,'ALEJANDRO','ZENO','MIRANDA',7,3.73,'alejandro.zeno@upr.edu');
...
CREATE TABLE `solicitud` (
  ...
  `status_sol` varchar(10) COLLATE utf8_spanish_ci NOT NULL,
  `cantidad_aprobada` varchar(5) COLLATE utf8_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`sol_id`),
  KEY `solicitud_ibfk_1` (`beca_id`),
  KEY `solicitud_ibfk_2` (`user_id`),
  CONSTRAINT `solicitud_ibfk_1` FOREIGN KEY (`beca_id`) REFERENCES `becas` (`beca_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
insert  into `solicitud`(`sol_id`,`user_id`,`beca_id`,`fecha_sol`,`actividad`,`costo`,`fecha_actividad`,`status_sol`,`cantidad_aprobada`) values 
(1,4,8,'2020-05-01','Materiales',200,'2020-05-18','Aceptado','200'),
(2,5,9,'2020-05-28','Matricula',300,'2020-05-18','Aceptado','300'),
(3,2,4,'2020-05-07','Proroga',500,'2020-05-18','Denegado','0'),
(4,1,4,'2020-05-10','Tutorias',300,'2020-05-18','Aceptado','300'),
(5,3,2,'2020-05-22','Taller de Señas',100,'2020-05-18','Aceptado','100'),
(6,6,1,'2020-05-13','Interes Propio',1000,'2020-05-18','Aceptado','1000');
