...
(1,'Beca Auxiliar',1000000,1000,1000000,2.50,'activa'),
(2,'Beca Legislativa',200000,200,200000,2.50,'activa'),
...
(6,'Beca Staying Alive',100000,750,100000,2.50,'activa'),
(7,'Beca Educacional',150000,500,150000,2.80,'activa'),
...
insert  into `becas_departamento`(`beca_id`,`depto_id`,`status`) values 
(8,7,'activa'),
(9,10,'activa'),
(10,8,'activa');
...
(1,'Alejandro','Zeno','Miranda',7,3.80,''),
(2,'Hiram','Vera','Mercado',7,3.90,''),
(3,'Gabriel X.','Ferrer','Torres',7,3.85,''),
(4,'Hector','Pérez','Rivera',1,3.50,''),
(5,'Julia','Tosado','Nuñez',2,3.64,''),
(6,'Karla','Martínez','Padín',3,3.87,''),
(7,'Marcos','Toledo','Villanueva',4,3.40,''),
(8,'Kevin O.','Colón','Gutiérrez',5,3.63,''),
(9,'Julio','Camacho','Chacón',6,3.90,''),
(10,'Arturo','González','Matos',8,3.20,''),
(11,'Carmen','Hernández','Jiménez',9,3.29,''),
(12,'Orlando','Acevedo','Serrano',10,3.73,''),
(13,'María','Pedraza','Acuña',11,3.69,''),
(14,'Paola','Curbelo','Del Valle',12,3.70,''),
(15,'Mirelis','Figueroa','Rodríguez',13,3.86,''),
(16,'Aixa','Ramírez','Toledo',7,3.90,''),
(17,'Roberto','Amador','Peña',7,3.70,'');
...
insert  into `solicitud`(`sol_id`,`user_id`,`beca_id`,`fecha_sol`,`actividad`,`costo`,`fecha_actividad`,`status`) values 
(1,4,8,'2020-05-13','Materiales',200,'2020-05-18','pendiente'),
(2,5,9,'2020-05-13','Matricula',300,'2020-05-18','pendiente'),
(3,2,10,'2020-05-13','Proroga',300,'2020-05-18','pendiente'),
(4,1,4,'2020-05-13','Tutorias',500,'2020-05-18','otorgada'),
(5,3,2,'2020-05-13','Taller de Señas',100,'2020-05-18','otorgada'),
(6,6,1,'2020-05-13','Interes Propio',1000,'2020-05-18','denegada');
